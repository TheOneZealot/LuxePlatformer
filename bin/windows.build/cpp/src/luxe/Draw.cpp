...
{
HX_STACK_FRAME("luxe.Draw","new",0xc8b456ce,"luxe.Draw.new","luxe/Draw.hx",295,0x47df6e81)
HX_STACK_THIS(this)
...
::phoenix::geometry::Geometry Draw_obj::ngon( Dynamic options){
	...
	HX_STACK_LINE(120)
	Float tmp15 = (_angle * ((Float)0.017453292519943278));		HX_STACK_VAR(tmp15,"tmp15");
	HX_STACK_LINE(120)
