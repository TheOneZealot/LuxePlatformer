...
Void Scene_obj::handle_duplicate_warning( ::String _name){
{
		...
		if ((tmp2)){
			...
			HX_STACK_LINE(96)
			::String tmp8 = (tmp7 + HX_HCSTRING("!\r\n                This will replace the existing one, possibly leaving the previous one in limbo.","\x35","\x43","\x4e","\x18"));		HX_STACK_VAR(tmp8,"tmp8");
			HX_STACK_LINE(96)
...
Void Scene_obj::add( ::luxe::Entity entity){
{
		...
		HX_STACK_LINE(109)
		{
			...
			if ((tmp3)){
				...
				HX_STACK_LINE(109)
				::String tmp9 = (tmp8 + HX_HCSTRING("!\r\n                This will replace the existing one, possibly leaving the previous one in limbo.","\x35","\x43","\x4e","\x18"));		HX_STACK_VAR(tmp9,"tmp9");
				HX_STACK_LINE(109)
...
Void Scene_obj::inputdown( Dynamic _event){
{
...
Void Scene_obj::inputup( Dynamic _event){
{
