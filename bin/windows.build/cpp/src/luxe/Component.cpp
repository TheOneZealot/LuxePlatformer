...
::String Component_obj::toString( ){
	HX_STACK_FRAME("luxe.Component","toString",0x6c95b455,"luxe.Component.toString","luxe/Component.hx",225,0xa970277a)
	HX_STACK_THIS(this)
	HX_STACK_LINE(226)
	::String tmp = this->name;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(226)
	::String tmp1 = (HX_HCSTRING("luxe Component: ","\x19","\xcd","\x61","\x82") + tmp);		HX_STACK_VAR(tmp1,"tmp1");
	HX_STACK_LINE(226)
	::String tmp2 = (tmp1 + HX_HCSTRING(" on ","\x01","\x6e","\x7b","\x15"));		HX_STACK_VAR(tmp2,"tmp2");
	HX_STACK_LINE(226)
	...
	HX_STACK_LINE(226)
	::String tmp6 = (tmp5 + HX_HCSTRING(" / id: ","\xf2","\xd8","\xfa","\xaf"));		HX_STACK_VAR(tmp6,"tmp6");
	HX_STACK_LINE(226)
