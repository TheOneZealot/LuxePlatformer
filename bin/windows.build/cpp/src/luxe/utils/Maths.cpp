...
Float Maths_obj::wrap_angle( Float degrees,Float lower,Float upper){
	...
	HX_STACK_LINE(51)
	Float tmp = (degrees * ((Float)0.017453292519943278));		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(51)
...
Float Maths_obj::degrees( Float radians){
	...
	HX_STACK_LINE(126)
	Float tmp = (radians * ((Float)57.29577951308238));		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(126)
	return tmp;
}
...
{
	_PI_OVER_180= ((Float)0.017453292519943278);
	_180_OVER_PI= ((Float)57.29577951308238);
}
