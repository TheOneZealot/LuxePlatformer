...
::luxe::InputType InputType_obj::unknown;
...
int InputType_obj::__FindIndex(::String inName)
{
	...
	if (inName==HX_HCSTRING("keys","\xf4","\xe1","\x06","\x47")) return 3;
...
static void sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(InputType_obj::unknown,"unknown");
};
...
static void sVisitStatic(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(InputType_obj::unknown,"unknown");
};
#endif
...
{
hx::Static(gamepad) = hx::CreateEnum< InputType_obj >(HX_HCSTRING("gamepad","\xa1","\xe0","\x85","\x89"),4);
hx::Static(keys) = hx::CreateEnum< InputType_obj >(HX_HCSTRING("keys","\xf4","\xe1","\x06","\x47"),3);
hx::Static(mouse) = hx::CreateEnum< InputType_obj >(HX_HCSTRING("mouse","\x25","\x16","\x65","\x0c"),1);
hx::Static(touch) = hx::CreateEnum< InputType_obj >(HX_HCSTRING("touch","\xbf","\x17","\x33","\x14"),2);
hx::Static(unknown) = hx::CreateEnum< InputType_obj >(HX_HCSTRING("unknown","\x8a","\x23","\x7b","\xe1"),0);
}
