...
HX_STACK_THIS(this)
{
	...
	HX_STACK_LINE(45)
	this->sim_delta = ((Float)0.016666666666666666);
	HX_STACK_LINE(42)
	this->frame_max_delta = ((Float)0.25);
	HX_STACK_LINE(40)
	this->frame_delta = ((Float)0.016666666666666666);
	HX_STACK_LINE(38)
	this->frame_start_prev = ((Float)0.0);
	HX_STACK_LINE(36)
	this->frame_start = ((Float)0.016666666666666666);
	HX_STACK_LINE(33)
	this->tick_delta = ((Float)0.016666666666666666);
	HX_STACK_LINE(31)
	this->tick_start_prev = ((Float)0.0);
	HX_STACK_LINE(29)
	this->tick_start = ((Float)0.016666666666666666);
	HX_STACK_LINE(24)
...
Void App_obj::internal_init( ){
{
		...
		this->sim_time = (int)0;
		HX_STACK_LINE(124)
		Float tmp = ((Float)0.016666666666666666);		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(124)
