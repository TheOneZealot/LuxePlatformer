...
Void Camera_obj::process( ){
{
		...
		{
			HX_STACK_LINE(211)
			bool tmp2 = this->cull_backfaces;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(211)
			if ((tmp2)){
				HX_STACK_LINE(211)
				::phoenix::Renderer tmp3 = ::Luxe_obj::renderer;		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(211)
				tmp3->state->enable((int)2884);
			}
			else{
				HX_STACK_LINE(211)
				::phoenix::Renderer tmp3 = ::Luxe_obj::renderer;		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(211)
				tmp3->state->disable((int)2884);
			}
		}
		HX_STACK_LINE(212)
		{
			HX_STACK_LINE(212)
			bool tmp2 = this->depth_test;		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(212)
			if ((tmp2)){
				HX_STACK_LINE(212)
				::phoenix::Renderer tmp3 = ::Luxe_obj::renderer;		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(212)
				tmp3->state->enable((int)2929);
			}
			else{
				HX_STACK_LINE(212)
				::phoenix::Renderer tmp3 = ::Luxe_obj::renderer;		HX_STACK_VAR(tmp3,"tmp3");
				HX_STACK_LINE(212)
				tmp3->state->disable((int)2929);
			}
		}
	}
return null();
...
{
		HX_STACK_FRAME("phoenix.Camera","on_transform_cleaned",0x6436d59f,"phoenix.Camera.on_transform_cleaned","phoenix/Camera.hx",221,0x1fcabb59)
		HX_STACK_THIS(this)
		HX_STACK_ARG(t,"t")
		HX_STACK_LINE(221)
		this->transform_dirty = true;
...
{
		HX_STACK_FRAME("phoenix.Camera","update_look_at",0x27c83a07,"phoenix.Camera.update_look_at","phoenix/Camera.hx",226,0x1fcabb59)
		HX_STACK_THIS(this)
		HX_STACK_LINE(228)
...
{
		HX_STACK_FRAME("phoenix.Camera","update_view_matrix",0x11cad60f,"phoenix.Camera.update_view_matrix","phoenix/Camera.hx",238,0x1fcabb59)
		HX_STACK_THIS(this)
		HX_STACK_LINE(240)
		::phoenix::Matrix tmp;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(240)
...
{
		HX_STACK_FRAME("phoenix.Camera","update_projection_matrix",0x7401e825,"phoenix.Camera.update_projection_matrix","phoenix/Camera.hx",253,0x1fcabb59)
		HX_STACK_THIS(this)
		HX_STACK_LINE(255)
		...
		HX_STACK_LINE(259)
		{
			...
			switch( (int)(_g->__Index())){
				...
				case (int)1: {
					...
					HX_STACK_LINE(265)
					Float tmp10 = (tmp9 * ((Float)0.017453292519943278));		HX_STACK_VAR(tmp10,"tmp10");
					HX_STACK_LINE(265)
...
{
		HX_STACK_FRAME("phoenix.Camera","apply_state",0xdb71c396,"phoenix.Camera.apply_state","phoenix/Camera.hx",293,0x1fcabb59)
		HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("phoenix.Camera","apply_default_camera_options",0xf72e1e5d,"phoenix.Camera.apply_default_camera_options","phoenix/Camera.hx",305,0x1fcabb59)
		HX_STACK_THIS(this)
		HX_STACK_LINE(305)
		::phoenix::ProjectionType tmp = this->projection;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(305)
...
Dynamic Camera_obj::default_camera_options( ){
	HX_STACK_FRAME("phoenix.Camera","default_camera_options",0x036c4aec,"phoenix.Camera.default_camera_options","phoenix/Camera.hx",327,0x1fcabb59)
	HX_STACK_THIS(this)
	struct _Function_1_1{
		inline static Dynamic Block( ){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","phoenix/Camera.hx",329,0x1fcabb59)
			{
				hx::Anon __result = hx::Anon_obj::Create();
				__result->Add(HX_HCSTRING("projection","\x8f","\x88","\x8b","\xc4") , ::phoenix::ProjectionType_obj::ortho,false);
				__result->Add(HX_HCSTRING("depth_test","\x4e","\x68","\x49","\xc9") , false,false);
...
::phoenix::Vector Camera_obj::ortho_screen_to_world( ::phoenix::Vector _vector){
	HX_STACK_FRAME("phoenix.Camera","ortho_screen_to_world",0x90978b50,"phoenix.Camera.ortho_screen_to_world","phoenix/Camera.hx",343,0x1fcabb59)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_vector,"_vector")
	HX_STACK_LINE(345)
	this->update_view_matrix();
...
::phoenix::Vector Camera_obj::ortho_world_to_screen( ::phoenix::Vector _vector){
	HX_STACK_FRAME("phoenix.Camera","ortho_world_to_screen",0x1f31d512,"phoenix.Camera.ortho_world_to_screen","phoenix/Camera.hx",351,0x1fcabb59)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_vector,"_vector")
	HX_STACK_LINE(353)
	this->update_view_matrix();
...
::phoenix::Vector Camera_obj::persepective_world_to_screen( ::phoenix::Vector _vector,::phoenix::Rectangle _viewport){
	HX_STACK_FRAME("phoenix.Camera","persepective_world_to_screen",0x526987d1,"phoenix.Camera.persepective_world_to_screen","phoenix/Camera.hx",359,0x1fcabb59)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_vector,"_vector")
	HX_STACK_ARG(_viewport,"_viewport")
	HX_STACK_LINE(361)
...
::phoenix::Vector Camera_obj::set_target( ::phoenix::Vector _target){
	HX_STACK_FRAME("phoenix.Camera","set_target",0x108f63f8,"phoenix.Camera.set_target","phoenix/Camera.hx",378,0x1fcabb59)
	HX_STACK_THIS(this)
...
Float Camera_obj::set_fov( Float _fov){
	HX_STACK_FRAME("phoenix.Camera","set_fov",0x5b6f7806,"phoenix.Camera.set_fov","phoenix/Camera.hx",388,0x1fcabb59)
	HX_STACK_THIS(this)
...
::phoenix::FOVType Camera_obj::set_fov_type( ::phoenix::FOVType _fov_type){
	HX_STACK_FRAME("phoenix.Camera","set_fov_type",0x0bbbc0d3,"phoenix.Camera.set_fov_type","phoenix/Camera.hx",402,0x1fcabb59)
	HX_STACK_THIS(this)
...
Float Camera_obj::set_aspect( Float _aspect){
	HX_STACK_FRAME("phoenix.Camera","set_aspect",0xd3aa067f,"phoenix.Camera.set_aspect","phoenix/Camera.hx",412,0x1fcabb59)
	HX_STACK_THIS(this)
...
Float Camera_obj::set_near( Float _near){
	HX_STACK_FRAME("phoenix.Camera","set_near",0xab5b99cf,"phoenix.Camera.set_near","phoenix/Camera.hx",420,0x1fcabb59)
	HX_STACK_THIS(this)
...
Float Camera_obj::set_far( Float _far){
	HX_STACK_FRAME("phoenix.Camera","set_far",0x5b6f6bd0,"phoenix.Camera.set_far","phoenix/Camera.hx",428,0x1fcabb59)
	HX_STACK_THIS(this)
...
Dynamic Camera_obj::set_ortho_left( Dynamic _val){
	HX_STACK_FRAME("phoenix.Camera","set_ortho_left",0x874231d5,"phoenix.Camera.set_ortho_left","phoenix/Camera.hx",436,0x1fcabb59)
	HX_STACK_THIS(this)
...
Dynamic Camera_obj::set_ortho_right( Dynamic _val){
	HX_STACK_FRAME("phoenix.Camera","set_ortho_right",0x49b6764e,"phoenix.Camera.set_ortho_right","phoenix/Camera.hx",444,0x1fcabb59)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_val,"_val")
	HX_STACK_LINE(446)
	this->projection_dirty = true;
...
Dynamic Camera_obj::set_ortho_top( Dynamic _val){
	HX_STACK_FRAME("phoenix.Camera","set_ortho_top",0xa27ef087,"phoenix.Camera.set_ortho_top","phoenix/Camera.hx",452,0x1fcabb59)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_val,"_val")
	HX_STACK_LINE(454)
	this->projection_dirty = true;
...
Dynamic Camera_obj::set_ortho_bottom( Dynamic _val){
	HX_STACK_FRAME("phoenix.Camera","set_ortho_bottom",0x4d43a039,"phoenix.Camera.set_ortho_bottom","phoenix/Camera.hx",460,0x1fcabb59)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_val,"_val")
	HX_STACK_LINE(462)
	this->projection_dirty = true;
...
Float Camera_obj::set_zoom( Float _z){
	HX_STACK_FRAME("phoenix.Camera","set_zoom",0xb351cbfa,"phoenix.Camera.set_zoom","phoenix/Camera.hx",469,0x1fcabb59)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_z,"_z")
	HX_STACK_LINE(471)
...
::phoenix::Vector Camera_obj::set_center( ::phoenix::Vector _p){
	HX_STACK_FRAME("phoenix.Camera","set_center",0x8f7d967c,"phoenix.Camera.set_center","phoenix/Camera.hx",506,0x1fcabb59)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_p,"_p")
	HX_STACK_LINE(508)
	this->center = _p;
...
::phoenix::Vector Camera_obj::get_center( ){
	HX_STACK_FRAME("phoenix.Camera","get_center",0x8bfff808,"phoenix.Camera.get_center","phoenix/Camera.hx",538,0x1fcabb59)
	HX_STACK_THIS(this)
	HX_STACK_LINE(540)
	::phoenix::Vector tmp = this->center;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(540)
...
::phoenix::Vector Camera_obj::get_pos( ){
	HX_STACK_FRAME("phoenix.Camera","get_pos",0x68757d81,"phoenix.Camera.get_pos","phoenix/Camera.hx",544,0x1fcabb59)
	HX_STACK_THIS(this)
	HX_STACK_LINE(546)
...
::phoenix::Quaternion Camera_obj::get_rotation( ){
	HX_STACK_FRAME("phoenix.Camera","get_rotation",0xff2a4231,"phoenix.Camera.get_rotation","phoenix/Camera.hx",550,0x1fcabb59)
	HX_STACK_THIS(this)
	HX_STACK_LINE(552)
	::phoenix::Transform tmp = this->transform;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(552)
...
::phoenix::Vector Camera_obj::get_scale( ){
	HX_STACK_FRAME("phoenix.Camera","get_scale",0x412883b7,"phoenix.Camera.get_scale","phoenix/Camera.hx",556,0x1fcabb59)
	HX_STACK_THIS(this)
	HX_STACK_LINE(558)
	::phoenix::Transform tmp = this->transform;		HX_STACK_VAR(tmp,"tmp");
	HX_STACK_LINE(558)
...
::phoenix::Rectangle Camera_obj::get_viewport( ){
	HX_STACK_FRAME("phoenix.Camera","get_viewport",0x93495159,"phoenix.Camera.get_viewport","phoenix/Camera.hx",562,0x1fcabb59)
	HX_STACK_THIS(this)
	HX_STACK_LINE(564)
...
::phoenix::Rectangle Camera_obj::set_viewport( ::phoenix::Rectangle _r){
	HX_STACK_FRAME("phoenix.Camera","set_viewport",0xa84274cd,"phoenix.Camera.set_viewport","phoenix/Camera.hx",568,0x1fcabb59)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_r,"_r")
	HX_STACK_LINE(570)
	this->projection_dirty = true;
...
::phoenix::Quaternion Camera_obj::set_rotation( ::phoenix::Quaternion _q){
	HX_STACK_FRAME("phoenix.Camera","set_rotation",0x142365a5,"phoenix.Camera.set_rotation","phoenix/Camera.hx",594,0x1fcabb59)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_q,"_q")
	HX_STACK_LINE(596)
...
::phoenix::Vector Camera_obj::set_scale( ::phoenix::Vector _s){
	HX_STACK_FRAME("phoenix.Camera","set_scale",0x24796fc3,"phoenix.Camera.set_scale","phoenix/Camera.hx",600,0x1fcabb59)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_s,"_s")
	HX_STACK_LINE(602)
	::phoenix::Vector tmp;		HX_STACK_VAR(tmp,"tmp");
...
::phoenix::Vector Camera_obj::set_pos( ::phoenix::Vector _p){
	HX_STACK_FRAME("phoenix.Camera","set_pos",0x5b770e8d,"phoenix.Camera.set_pos","phoenix/Camera.hx",606,0x1fcabb59)
	HX_STACK_THIS(this)
	HX_STACK_ARG(_p,"_p")
	HX_STACK_LINE(608)
	this->pos = _p;
...
{
		HX_STACK_FRAME("phoenix.Camera","_merge_options",0x6b347742,"phoenix.Camera._merge_options","phoenix/Camera.hx",646,0x1fcabb59)
		HX_STACK_THIS(this)
		HX_STACK_ARG(_o,"_o")
		HX_STACK_LINE(649)
		{
...
{
		HX_STACK_FRAME("phoenix.Camera","_pos_changed",0x32241af4,"phoenix.Camera._pos_changed","phoenix/Camera.hx",669,0x1fcabb59)
		HX_STACK_THIS(this)
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(671)
		::phoenix::Vector tmp = this->pos;		HX_STACK_VAR(tmp,"tmp");
...
{
		HX_STACK_FRAME("phoenix.Camera","_center_changed",0xdc3d733f,"phoenix.Camera._center_changed","phoenix/Camera.hx",675,0x1fcabb59)
		HX_STACK_THIS(this)
		HX_STACK_ARG(v,"v")
		HX_STACK_LINE(677)
		::phoenix::Vector tmp = this->center;		HX_STACK_VAR(tmp,"tmp");
