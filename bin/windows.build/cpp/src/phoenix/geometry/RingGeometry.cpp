...
{
		HX_STACK_LINE(60)
		Float tmp = (_start_angle_degrees * ((Float)0.017453292519943278));		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(60)
		Float _start_angle_rad = tmp;		HX_STACK_VAR(_start_angle_rad,"_start_angle_rad");
		HX_STACK_LINE(61)
		Float tmp1 = (_end_angle_degrees * ((Float)0.017453292519943278));		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(61)
