...
::phoenix::Vector Vector_obj::degrees( ){
	...
	HX_STACK_LINE(767)
	{
		...
		Float tmp = this->x;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(767)
		Float tmp1 = (tmp * ((Float)57.29577951308238));		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(767)
		Float _x = tmp1;		HX_STACK_VAR(_x,"_x");
		HX_STACK_LINE(767)
		Float tmp2 = this->y;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(767)
		Float tmp3 = (tmp2 * ((Float)57.29577951308238));		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(767)
		Float _y = tmp3;		HX_STACK_VAR(_y,"_y");
		HX_STACK_LINE(767)
		Float tmp4 = this->z;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(767)
		Float tmp5 = (tmp4 * ((Float)57.29577951308238));		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(767)
		Float _z = tmp5;		HX_STACK_VAR(_z,"_z");
		HX_STACK_LINE(767)
		bool tmp6 = this->ignore_listeners;		HX_STACK_VAR(tmp6,"tmp6");
...
::phoenix::Vector Vector_obj::radians( ){
	...
	HX_STACK_LINE(775)
	{
		...
		Float tmp = this->x;		HX_STACK_VAR(tmp,"tmp");
		HX_STACK_LINE(775)
		Float tmp1 = (tmp * ((Float)0.017453292519943278));		HX_STACK_VAR(tmp1,"tmp1");
		HX_STACK_LINE(775)
		Float _x = tmp1;		HX_STACK_VAR(_x,"_x");
		HX_STACK_LINE(775)
		Float tmp2 = this->y;		HX_STACK_VAR(tmp2,"tmp2");
		HX_STACK_LINE(775)
		Float tmp3 = (tmp2 * ((Float)0.017453292519943278));		HX_STACK_VAR(tmp3,"tmp3");
		HX_STACK_LINE(775)
		Float _y = tmp3;		HX_STACK_VAR(_y,"_y");
		HX_STACK_LINE(775)
		Float tmp4 = this->z;		HX_STACK_VAR(tmp4,"tmp4");
		HX_STACK_LINE(775)
		Float tmp5 = (tmp4 * ((Float)0.017453292519943278));		HX_STACK_VAR(tmp5,"tmp5");
		HX_STACK_LINE(775)
		Float _z = tmp5;		HX_STACK_VAR(_z,"_z");
		HX_STACK_LINE(775)
		bool tmp6 = this->ignore_listeners;		HX_STACK_VAR(tmp6,"tmp6");
...
::phoenix::Vector Vector_obj::Degrees( ::phoenix::Vector _radian_vector){
	...
	HX_STACK_LINE(783)
	{
		...
		{
			HX_STACK_LINE(783)
			Float tmp2 = (_this->x * ((Float)57.29577951308238));		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(783)
			Float _x = tmp2;		HX_STACK_VAR(_x,"_x");
			HX_STACK_LINE(783)
			Float tmp3 = (_this->y * ((Float)57.29577951308238));		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(783)
			Float _y = tmp3;		HX_STACK_VAR(_y,"_y");
			HX_STACK_LINE(783)
			Float tmp4 = (_this->z * ((Float)57.29577951308238));		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(783)
...
::phoenix::Vector Vector_obj::Radians( ::phoenix::Vector _degree_vector){
	...
	HX_STACK_LINE(789)
	{
		...
		{
			HX_STACK_LINE(789)
			Float tmp2 = (_this->x * ((Float)0.017453292519943278));		HX_STACK_VAR(tmp2,"tmp2");
			HX_STACK_LINE(789)
			Float _x = tmp2;		HX_STACK_VAR(_x,"_x");
			HX_STACK_LINE(789)
			Float tmp3 = (_this->y * ((Float)0.017453292519943278));		HX_STACK_VAR(tmp3,"tmp3");
			HX_STACK_LINE(789)
			Float _y = tmp3;		HX_STACK_VAR(_y,"_y");
			HX_STACK_LINE(789)
			Float tmp4 = (_this->z * ((Float)0.017453292519943278));		HX_STACK_VAR(tmp4,"tmp4");
			HX_STACK_LINE(789)
			Float _z = tmp4;		HX_STACK_VAR(_z,"_z");
			HX_STACK_LINE(789)
			bool prev = _this->ignore_listeners;		HX_STACK_VAR(prev,"prev");
