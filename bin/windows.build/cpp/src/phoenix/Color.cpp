...
::phoenix::Color Color_obj::fromColorHSL( ::phoenix::ColorHSL _color_hsl){
	...
	HX_STACK_LINE(221)
	Float tmp9 = ((Float)0.33333333333333331);		HX_STACK_VAR(tmp9,"tmp9");
	HX_STACK_LINE(221)
	...
	HX_STACK_LINE(223)
	Float tmp12 = ((Float)0.33333333333333331);		HX_STACK_VAR(tmp12,"tmp12");
	HX_STACK_LINE(223)
	...
	HX_STACK_LINE(227)
	{
		...
		while((true)){
			...
			HX_STACK_LINE(234)
			Float tmp21 = ((Float)0.16666666666666666);		HX_STACK_VAR(tmp21,"tmp21");
			HX_STACK_LINE(234)
